...
public class StudentUpdate extends HttpServlet {
	...
	// --List 사용자가 보내준 값 받기  out.print("<a href=StudentUpdate?hakbun="+vo.getHakbun()+" class=\"btn btn-sm btn-primary\">수정</a>&nbsp;");
		...
		//출력없이 데이터만 전송할 목적 (hidden) > 번호, 페이지 => 사용자 중심
		out.println("<input type=text name=name size=20 class=input-sm value="+vo.getName()+">"); //input 안에 value
		out.println("</td>");
		out.println("</tr>");
