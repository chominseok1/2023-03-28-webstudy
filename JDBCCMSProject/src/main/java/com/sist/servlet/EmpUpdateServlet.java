...
public class EmpUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String mode=request.getParameter("mode");// 사용자가 보내주는 데이터
		String empno=request.getParameter("empno");// 사용자가 보내주는 데이터
		EmpVO vo=dao.empUpdateData(Integer.parseInt(empno)); //데이터베이스 
	     ...
	     out.write("<form method=post action=EmpUpdateServlet>"); //EmpInsertServlet 갖고있는 post호출
