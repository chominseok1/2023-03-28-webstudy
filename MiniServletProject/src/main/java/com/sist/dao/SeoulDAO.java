...
public class SeoulDAO {
	...
	public List<SeoulVO> seoulListData(int page)
	{
		...
		{
			getConnection();
			String sql="SELECT no,title,poster,num " //,msg,address,hit 상세보기에서
	...
	// 서울 네이쳐
	public List<SeoulVO> seoulNatureList(int page)
	{
		List<SeoulVO> list=new ArrayList<SeoulVO>();
		try
		{
