...
let u=0;
$(function(){ //jquery 시작 => $(document).ready(function(){})
	...
	<div class="container">
		...
		<div class="row">
			       		...
			       		<tr>
			       		 ...
			       		 <td class="text-right">
			       		  ...
			       		  %>
			       		  			 ...
			       		  			 <a href="reply_delte.jsp?no=<%=rvo.getNo() %>&bno=<%=rvo.getBno()%>" class="btn btn-xs btn-warning">삭제</a>
			       		  <%			
			       		  		}
			       		  	}
			       		  %>
			...
			<div class="col-sm-4">
			 <%-- 인기 게시물 --%>
			 <table class="table">
			 <caption>인기 Top10 게시물</caption> <!-- 테이블의 제목 -->
			 <tr>
			  <th>제목</th>
			  <th>이름</th>
			 </tr>
