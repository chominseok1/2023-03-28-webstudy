<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%--
 	id name 일치 해야함 A a=new A(); b.setName (x)
 	<jsp:useBean id="bean" class="com.sist.temp.SawonBean">
 	...
 	---------------------------
 	 	jsp 액션 태그
 	 	=> 화면 이동 , 화면 연결, 값 전송 , 객체 생성, 멤버변수에 값 주입,멤버변수의 값을 읽기
 	 		 						 		  				<jsp:getProperty>
 	 		 						 		  <jsp:setProperty>
 	 		 						 <jsp:useBean>
 	 		 |			|	 ***<jsp:param>
 ...
 값을설정<jsp:setProperty> : 변수에 값을 설정(쓰기)
 	...
 	---------------------------
 값을갖고오기<jsp:getProperty> : 값을 읽어오기
 	=> getter
